...
<div id="tkpht">To take a photo, please enter your pets name and click here</div>

<script type="text/javascript">
   function enablephoto(val) {
	<?php print 'var gu="'.$guid.'";'; print "\n"; ?>
	stri = "<a href='../photo.php?guid="+gu+"&petname="+val+"'>Take Photo</a><br>";
