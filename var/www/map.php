...
<select name='duration'>
  ...
  echo " value='1'>Day</option>
  <option ";
  if ($dur_in==2) echo " selected ";
  echo " value='2'>Week</option>
  <option ";
  if ($dur_in==3) echo " selected ";
  echo " value='3'>Month</option>
  <option ";
  if ($dur_in==4) echo " selected ";
  echo " value='4'>Year</option>
</select>
  starting at Latitude: 
<INPUT TYPE = 'TEXT' id='fname1' Name ='lat' value='$lat' maxlength=12 size=10>
 Longitude:
<INPUT TYPE = 'TEXT' id='fname2' Name ='long' value='$long' maxlength=12 size=10>";
if ($l > 0)
...
<script type="text/javascript">
	function mylocs() {
		document.getElementById("locats").innerHTML = "Please choose one of your saved locations: <select onchange='selectlocs(this)'><option>Select..</option><?php for ($c = 0; $c < $l; $c++) { echo "<option value='".$arrlat[$c].",".$arrlong[$c]."'>".$locname[$c]."</option>";}?></select>";
	}
	function selectlocs(mySelect) {
