...
<ul>
<li id=selected>Remove Pet</li>
<li><a href="securemenu.php">Back</a></li>
</ul>
<p>
<h2>Are you sure ?</h2>
<p>
<FORM NAME ="form1" METHOD ="POST" ACTION ="reg_with_db.php?remove=1">

Username: <INPUT TYPE = 'TEXT' Name ='uname'  readonly='true' value="<?PHP print $uname;?>" maxlength="20">
<p>
Country: <select name="location" readonly='true'>
...
<p>
Nearest city: <INPUT TYPE = 'TEXT' Name ='city' readonly='true' value="<?PHP print $array[CITY];?>" maxlength="20">
<p>
Pet Name: <INPUT TYPE = 'TEXT' Name ='petname' readonly='true' value="<?PHP print $petname;?>" maxlength="20">
<p>
Pet Age (months): <INPUT TYPE = 'INT' Name ='petage' readonly='true' value="<?PHP print $array[PETAGE];?>" maxlength="2">
<p>
Pet Sex (M or F):<select name="petsex" readonly='true'>
  <option value="">Select...</option>
...
<p>
Species: <select name="pettype" readonly='true'>
...
<p>
Breed: <INPUT TYPE = 'TEXT' Name ='breed' readonly='true' value="<?PHP print $array[BREED];?>" maxlength="20">
<p>
